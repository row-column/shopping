			...
			<div class="col2">
				...
				<div class="account">
					<h4 class="colr bold smallheading upper">
						<span class="arrow">Recently Orders</span>
					</h4>
					<div class="accinner">
							...
							<div class="account_table">
								<s:if test="orderList.size>0">
									...
									<ul class="headtable">
										...
										<li class="consingee colr bold">收货人</li>
										<li class="ordertotal colr bold">订单金额</li>
										<li class="date colr bold">下单时间</li>
										<li class="status colr bold">订单状态</li>
									...
									<s:iterator value="orderList" status="status">
										...
										<s:if test="#status.even">
											<ul class="contable grey">
												<li class="orderCode"><a href="#"><s:property
															value="orderCode" />
												</a>
												</li>
												<li class="commodityName"><a href="#"><s:property
															value="commodityName" />
												</a>
												</li>
												<li class="consingee"><s:property value="consignee" />
												</li>
												<li class="ordertotal">￥<s:property value="amount" />
												</li>
												<li class="date"><s:property value="orderTime" />
												</li>
												<li class="status"><s:if test="status==1">
	                                       	订单处理中
												...
												<li class="action"><a
													href="orderDetail.action?id=<s:property value="id"/>"
													class="first">查看</a>
												</li>
											</ul>
										</s:if>
