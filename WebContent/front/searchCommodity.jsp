	...
	<div id="wrapper_sec">
		...
		<div id="crumb">
			<ul>
				...
				<li class="last"><a href="#" class="colr bold">Products</a>
				</li>
			</ul>
		</div>
		<div class="clear"></div>
            ...
            -->
				...
				<div class="listing">
					...
					<ul id="gridView" class="listingprods">
						<s:if test="searchCommodityList.size>0">
							<s:iterator value="searchCommodityList" status="status">
					...
					<ul id="listView" class="listinglist" style="display: none;">
						...
						<s:if test="searchCommodityList.size>0">
							<s:iterator value="searchCommodityList">
								<li>
									<div class="thumb">
										<a href="detail.action?id=<s:property value="id"/>"
											onclick="addRecentlyViewed('<s:property value="id"/>')"><img
											src="images/prod1.gif" alt="" />
										</a>
									</div>
									<div class="desc">
										<h5>
