	...
	<div id="wrapper_sec">
		...
		<div id="crumb">
			<ul>
				...
				<li class="last"><a href="#" class="colr bold">我的收藏夹</a>
				</li>
			</ul>
		</div>
		<div class="clear"></div>
			...
			<div class="col2">
				...
				<div class="account">
					<h4 class="colr bold smallheading upper">
						<span class="arrow">MY FAVORITES</span>
					</h4>
					<div class="accinner">
											...
											<ul class="contable grey" id="<s:property value="id"/>">
	                                       	...
	                                       	有货
												...
												<li class="action"
													style="margin: 25px 0px 0px 0px; color: #333333;"><a
													href="#"
													onclick="removeFromFavorites('<s:property value="id"/>')"
													class="first">删除</a>
												</li>
											</ul>
										</s:if>
