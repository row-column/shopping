	...
	<div id="wrapper_sec">
		...
		<div id="crumb">
			<ul>
				...
				<li class="last"><a href="#" class="colr bold">修改密码</a>
				</li>
			</ul>
		</div>
		<div class="clear"></div>
			...
			<div class="col2">
				...
				<div class="account">
					<h4 class="colr bold smallheading upper">
						<span class="arrow">update password</span>
					</h4>
					<div class="accinner">
									...
									<table border="0" cellpadding="0" cellspacing="0">
										...
										<tbody>
											...
											<tr>
												...
												<th><span class="txt">旧密码：<font color="red">*</font>
												</span>
												</th>
												<td><input id="oldPassword" name="user.oldPassword"
													type="password" class="inputSize" /><span
													id="oldPasswordInfo" style="display: none"><font
														color="red">请填写旧密码</font>
												</span></td>
											</tr>

											<tr>
												<th><span class="txt">新密码：<font color="red">*</font>
												</span>
												</th>
												<td><input id="password" name="user.password"
													type="password" class="inputSize" /><span
													id="passwordInfo" style="display: none"><font
														color="red">请填写新密码</font>
												</span>
												</td>
											</tr>
											<tr>
												<th><span class="txt">确认密码：<font color="red">*</font>
												</span>
												</th>
												<td><input id="confirmPassword" type="password"
													class="inputSize" /><span id="confirmPasswordInfo"
													style="display: none"><font color="red">新密码与旧密码不一致</font>
												</span>
												</td>
											</tr>
      ...
      $("#updateInfoBtn").click(function(){
		 ...
		 var confirmPassword=$("#confirmPassword").val();
    	  ...
    	  if(confirmPassword.length==0&&confirmPassword==''){
    		  $("#confirmPasswordInfo").show();
    	  }
    	  
    	  $("#confirmPassword").click(function(){
    		  $("#confirmPasswordInfo").hide();
    	  });
    	  
    	  
    	  if(oldPassword.length>0&&oldPassword!=''&&password.length>0&&password!=''&&confirmPassword.length>0&&confirmPassword!=''){
    		  
              jQuery.ajax({
  				type : "post",
  				url : "userJson_updateUserPassword.action",
  				dataType : 'text',
